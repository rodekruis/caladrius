...
export class PointInfoTable extends Table {
 ...
 renderTableData() {
    ...
    if (Object.keys(this.props.selected_datum).length) {
      ...
      prediction = this.props.selected_datum.prediction.toString().slice(0,4)
  ...
  renderTableData() {
    ...
    if (this.props.data.length) {
      count_data = [categoryCounter(this.props.data, 0.0, this.props.damage_boundary_a),
        ...
        categoryCounter(this.props.data, this.props.damage_boundary_b, 1.0)]
      average_data = [categoryAverager(this.props.data, 0.0, this.props.damage_boundary_a),
        categoryAverager(this.props.data, this.props.damage_boundary_a, this.props.damage_boundary_b),
        categoryAverager(this.props.data, this.props.damage_boundary_b, 1.0)]
    }
    return (
      <tbody>
